export const VALIDATION_MESSAGES = {
  ...
  mustBeGreaterThan: (num: number) => `This field must be greater than or equal to ${num}.`,
  mustBeLessThan: (num: number) => `This field must be less than or equal to ${num}.`,
  lengthMustBeGreaterThan: (num: number) => `This field length must be at least ${num} characters long.`,
  lengthMustBeLessThan: (num: number) => `This field length must be less than or equal to ${num} characters long.`,
